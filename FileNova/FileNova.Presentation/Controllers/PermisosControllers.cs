...
namespace FileNova.Presentation.Controllers
{
    ...
    public class PermisosControllers : ControllerBase
    {
        ...
        public async Task<IActionResult> GetUserPermissions(Guid userId, [FromQuery] bool trackChanges)
        {
        ...
        public async Task<IActionResult> RemovePermissionFromUser(Guid userId, int permisoId)
        {
